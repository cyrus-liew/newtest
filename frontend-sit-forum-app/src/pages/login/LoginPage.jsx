                ...
                <form onSubmit={handleSubmit(submitHandler)}>
                    ...
                    <div className="flex flex-col mb-6 w-full">
                        ...
                        <input type="password" id="password"
                            ...
                            placeholder="Enter Password" className={`placeholder:text-[#959ead] text-dark-hard mt-3 rounded-lg px-5 py-4 font-semibold block outline-none ${errors.password ? "border border-red-500" : "border border-[#c3cad9]"}`} />
                     {errors.password && (
                    ...
                    <p className="text-sm font-semibold text-[#5a7184]">
                        Do not have an account? <Link to="/userregister" className="text-primary">
                            Register Now </Link>
